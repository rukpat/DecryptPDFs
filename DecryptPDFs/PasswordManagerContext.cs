...
public class PasswordManagerContext : DbContext
{
    ...
    {
        // %LocalAppData%\DecryptPDFs\DecryptPDFs.db
        ...
        var dbDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "DecryptPDFs");
        var dbPath = Path.Combine(dbDirectory, "DecryptPDFs.db");
